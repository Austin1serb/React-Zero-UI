export const InnerDot = () => {
	return (
		<Layer1>
			<Layer2>
				<Layer3>
					<div className="theme-test-light:bg-blue-400 theme-test-dark:bg-red-400 absolute top-1/2 left-1/2 h-[2px] w-[2px] -translate-x-1/2 -translate-y-1/2 rounded-full" />
				</Layer3>
			</Layer2>
		</Layer1>
	);
